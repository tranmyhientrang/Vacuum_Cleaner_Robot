...
#include <vcr_gmapping/vcr_flat_world_imu_node.h>

VcrFlatWorldImuNode::VcrFlatWorldImuNode()
{
...
bool VcrFlatWorldImuNode::init()
{
  publisher_  = nh_.advertise<sensor_msgs::Imu>("imu_out", 10);
  subscriber_ = nh_.subscribe("imu_in", 150, &VcrFlatWorldImuNode::msgCallback, this);

  return true;
}

void VcrFlatWorldImuNode::msgCallback(const sensor_msgs::ImuConstPtr imu_in)
{
...
int main(int argc, char* argv[])
{
  ...
  VcrFlatWorldImuNode vcr_flat_world_imu_node;
